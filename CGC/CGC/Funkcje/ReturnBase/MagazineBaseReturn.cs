...
namespace CGC.Funkcje.MagazineFuncFolder.MagazineBase
{
    public class MagazineBaseReturn
    {
        ...
        {
            List<string> temp = new List<string>();
            SqlCommand command = new SqlCommand("Select TOP(1) Global_id From [Color] ORDER BY convert(int, Global_id) DESC WHERE Company = @Company", connect.cnn);
            connect.cnn.Open();
        ...
        {
            List<string> temp = new List<string>();
            SqlCommand command = new SqlCommand("Select TOP(1) Global_id From [Glass_type] ORDER BY convert(int, Global_id) DESC WHERE Company = @Company", connect.cnn);
            connect.cnn.Open();
        ...
        public List<Magazine_History> GetLastGlobalIdMagazineHistory(string company)
        {
            ...
            SqlCommand command = new SqlCommand("Select TOP(1) Global_id From [Magazine_History] ORDER BY convert(int, Global_id) DESC WHERE Company = @Company", connect.cnn);
            connect.cnn.Open();
            ...
            {
                Magazine_History magazine_History = new Magazine_History();
                magazine_History.Global_Id = Convert.ToInt32(sqlDataReader["Global_id"]);
